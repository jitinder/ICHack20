              ...
              o -> {
                ...
                AsyncTask.execute(
                    () -> {
                      ...
                      url =
                          Uri.parse(
                              "https://media-cdn.tripadvisor.com/media/photo-s/0e/4a/68/50/receipt.jpg");
                      ...
                      executor.execute(
                          new Holder(
                              new String[] {
                                readURI, url.toString(), null, "", imageToAnalyze.toString()
                              },
                              getFilesDir()));
                    });
              });
          ...
          FileOutputStream fos =
              new FileOutputStream(
                  holders[0].directory
                      + "/output/"
                      + holders[0].strings[4]
                      + ".json"); // Tokenise to get only between scanned and .jpg
